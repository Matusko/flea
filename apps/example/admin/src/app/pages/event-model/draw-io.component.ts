    ...
    <diagram name="Page-1" id="AeLBjCoLBt38s6I4U-rd">
        <mxGraphModel dx="1434" dy="807" grid="1" gridSize="10" guides="1" tooltips="1" connect="1" arrows="1" fold="1"
            ...
            <root>
                ...
                <mxCell id="JncBnf603iRC5ToNbfT_-6"
                        style="edgeStyle=orthogonalEdgeStyle;rounded=0;orthogonalLoop=1;jettySize=auto;html=1;entryX=0.5;entryY=0;entryDx=0;entryDy=0;curved=1;"
                        edge="1" parent="1" source="JncBnf603iRC5ToNbfT_-4" target="JncBnf603iRC5ToNbfT_-5">
                    <mxGeometry relative="1" as="geometry"/>
                </mxCell>

                <mxCell id="JncBnf603iRC5ToNbfT_-4" value="Automation"
                        style="rounded=1;whiteSpace=wrap;html=1;fillColor=#e1d5e7;strokeColor=#9673a6;" vertex="1"
                        parent="1">
                    <mxGeometry x="90" y="40" width="120" height="60" as="geometry"/>
                </mxCell>

                <mxCell id="JncBnf603iRC5ToNbfT_-7"
                        style="edgeStyle=orthogonalEdgeStyle;rounded=0;orthogonalLoop=1;jettySize=auto;html=1;entryX=0.433;entryY=-0.067;entryDx=0;entryDy=0;entryPerimeter=0;curved=1;"
                        edge="1" parent="1" source="JncBnf603iRC5ToNbfT_-5" target="JncBnf603iRC5ToNbfT_-2">
                    <mxGeometry relative="1" as="geometry"/>
                </mxCell>

                <mxCell id="JncBnf603iRC5ToNbfT_-5" value="Command"
                        style="rounded=1;whiteSpace=wrap;html=1;fillColor=#dae8fc;strokeColor=#6c8ebf;" vertex="1"
                        parent="1">
                    <mxGeometry x="130" y="210" width="120" height="60" as="geometry"/>
                </mxCell>

                <mxCell id="JncBnf603iRC5ToNbfT_-11"
                        style="edgeStyle=orthogonalEdgeStyle;rounded=0;orthogonalLoop=1;jettySize=auto;html=1;entryX=0.5;entryY=1;entryDx=0;entryDy=0;curved=1;"
                        edge="1" parent="1" source="JncBnf603iRC5ToNbfT_-8" target="JncBnf603iRC5ToNbfT_-10">
                    <mxGeometry relative="1" as="geometry"/>
                </mxCell>

                <mxCell id="JncBnf603iRC5ToNbfT_-8" value="Read Model"
                        style="rounded=1;whiteSpace=wrap;html=1;fillColor=#d5e8d4;strokeColor=#82b366;" vertex="1"
                        parent="1">
                    <mxGeometry x="300" y="210" width="120" height="60" as="geometry"/>
                </mxCell>

                <mxCell id="JncBnf603iRC5ToNbfT_-9"
                        style="edgeStyle=orthogonalEdgeStyle;rounded=0;orthogonalLoop=1;jettySize=auto;html=1;entryX=0.5;entryY=1;entryDx=0;entryDy=0;curved=1;"
                        edge="1" parent="1" target="JncBnf603iRC5ToNbfT_-8">
                    <mxGeometry relative="1" as="geometry">
                        <mxPoint x="310" y="380" as="sourcePoint"/>
                        <mxPoint
                                x="282" y="396" as="targetPoint"/>
                    </mxGeometry>
                </mxCell>
                <mxCell id="JncBnf603iRC5ToNbfT_-10" value="Wireframe" style="rounded=1;whiteSpace=wrap;html=1;"
                        vertex="1" parent="1">
                    <mxGeometry x="340" y="40" width="120" height="60" as="geometry"/>
                </mxCell>
            </root>
