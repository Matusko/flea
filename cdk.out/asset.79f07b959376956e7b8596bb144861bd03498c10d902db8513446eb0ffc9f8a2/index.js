...
// libs/flea/public-bus/src/lib/app/authorizer/index.ts
...
async function fetchJson(uri, requestOptions, data) {
  ...
  return new Promise((resolve, reject) => {
    ...
    if (requestOptions == null ? void 0 : requestOptions.responseTimeout) {
    ...
    function done(...args) {
      ...
      (_a = req.socket) == null ? void 0 : _a.emit("agentRemove");
      let error = args[0];
...
var SimpleJsonFetcher = class {
  constructor(props) {
    this.defaultRequestOptions = {
      ...
      ...props == null ? void 0 : props.defaultRequestOptions
    };
  }
  /**
...
var SimplePenaltyBox = class {
  constructor(props) {
    ...
    this.waitSeconds = (props == null ? void 0 : props.waitSeconds) ?? 10;
  }
  async wait(jwksUri) {
...
var SimpleJwksCache = class {
  constructor(props) {
    ...
    this.penaltyBox = (props == null ? void 0 : props.penaltyBox) ?? new SimplePenaltyBox();
    this.fetcher = (props == null ? void 0 : props.fetcher) ?? new SimpleJsonFetcher();
  }
...
function validateJwtFields(payload, options) {
  ...
  if (options.scope != null) {
    assertStringArraysOverlap("Scope", (_a = payload.scope) == null ? void 0 : _a.split(" "), options.scope, JwtInvalidScopeError);
  }
}
...
var KeyObjectCache = class {
  ...
  transformJwkToKeyObjectSync(jwk, jwtHeaderAlg, issuer) {
    ...
    const fromCache = (_b = (_a = this.publicKeys.get(issuer)) == null ? void 0 : _a.get(jwk.kid)) == null ? void 0 : _b.get(alg);
    if (fromCache)
      return fromCache;
  ...
  putKeyObjectInCache(issuer, kid, alg, publicKey) {
    ...
    const cachedIssuerKid = cachedIssuer == null ? void 0 : cachedIssuer.get(kid);
    if (cachedIssuerKid) {
...
var CognitoJwtVerifier = class _CognitoJwtVerifier extends JwtRsaVerifierBase {
  ...
  static create(verifyProperties, additionalProperties) {
    return new this(verifyProperties, additionalProperties == null ? void 0 : additionalProperties.jwksCache);
  }
  /**
